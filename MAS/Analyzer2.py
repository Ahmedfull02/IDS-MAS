...
MODEL_PATH = "MAS/model/RF/model.pkl" #" MAS/model/RF/model.pkl"
ENCODER_PATH = "MAS/model/RF/encoder_y.pkl" 
METRICS_PATH = "MAS/model/RF/metric_results.json"
IMPORTANCE8PATH = "MAS/model/RF/importance_df.json"
...
class RFAnalyzerAgent(Agent):
    ...
    async def setup(self):
        ...
        print(f"\n\n\n[RFAnalyzer] Agent {self.jid} started\n\n\n")