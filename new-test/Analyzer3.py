    ...
    class AnalyzeBehaviour(CyclicBehaviour):
        ...
        async def run(self):
            ...
            if msg:
                ...
                print(f"[XGBAnalyzer] Received data for ID {data_id}")
                ...
                print(f"[XGBAnalyzer] Prediction: {prediction} for ID {data_id}")
                ...
                print(f"[XGBAnalyzer] ✓ Prediction sent to Collector (ID: {data_id}, Prediction: {prediction})")
